    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        if let tbC = self.window?.rootViewController as? UITabBarController {
            ...
            if let tbItems = tbC.tabBar.items {
                ...
                tbItems[0].image = UIImage(systemName: "calendar")
                tbItems[1].image = UIImage(systemName: "doc.on.doc")
                tbItems[2].image = UIImage(systemName: "photo")
                ...
                for tbItem in tbItems {
                    ...
                    tbItem.setTitleTextAttributes([.font: UIFont.systemFont(ofSize: 14)], for: .normal)
            ...
            // UITabBar.appearance() -> 외형 프록시 객체 = 소속 객체들의 프로퍼티 일괄 설정 (반복 X)
        }
    }
